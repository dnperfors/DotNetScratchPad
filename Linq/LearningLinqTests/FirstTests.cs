...
namespace LearningLinqTests
{
    public class FirstTests
    {
        ...
        public void Should_throw_ArgumentNullException_when_source_is_null()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => source.First(x => x > 5));
        }
